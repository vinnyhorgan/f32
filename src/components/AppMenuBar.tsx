...
export function AppMenuBar({
  ...
  return (
    <div
      data-no-select
      className="border-border bg-background/80 shrink-0 border-b backdrop-blur-sm"
    >
      <Menubar className="h-8 rounded-none border-none bg-transparent px-1 shadow-none">
        <MenubarMenu>
          <MenubarTrigger className="data-[state=open]:bg-accent px-2.5 py-1 text-xs font-normal">
            File
          </MenubarTrigger>
          <MenubarContent align="start" className="min-w-[180px]">
            ...
            <MenubarItem disabled>Export Memory Dump...</MenubarItem>
            <MenubarSeparator />
            <MenubarItem>
              Exit
        ...
        <MenubarMenu>
          ...
          <MenubarContent align="start" className="min-w-[180px]">
            ...
            <MenubarSeparator />
            <MenubarItem disabled>Write Byte...</MenubarItem>
            <MenubarItem disabled>Set Register...</MenubarItem>
          </MenubarContent>
        </MenubarMenu>
        ...
        <MenubarMenu>
          ...
          <MenubarContent align="start" className="min-w-[180px]">
            <MenubarItem disabled>M68K Reference</MenubarItem>
            <MenubarSub>
            ...
            <MenubarSeparator />
            <MenubarItem disabled className="text-muted-foreground text-[10px]">
